...
export const reviews = [
  ...
  },
  {
    ...
    name: "Martha Vasquez",
    review:
      "The Great Waves is the essential resource each person needs to prepare themselves mentally, emotionally and practically for the great change that is coming. Wonderful effort overall. Liked a lot.",
  },
  {
    imgUrl: UserPic,
    name: "Billy Hudson",
